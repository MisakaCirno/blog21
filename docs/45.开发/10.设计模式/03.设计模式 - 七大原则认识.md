...
![image-20220224195635097](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220224195736.png)
...
![image-20220224200505149](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220224200507.png)
...
![image-20220224203106674](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220224203107.png)
...
![image-20220224203440696](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220224203441.png)
...
![image-20220226103414310](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220226215410.png)

> 聚合图

B 需要 A 的三个方法，但不是继承，而是通过方法参数、构造器、setter 传入 A 的对象。

![image-20220226103435911](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220226215412.png)

> 组合图

B 需要 A 的三个方法，直接通过 `new A` 获得 A 的对象。

![image-20220226103439980](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220226215413.png)
