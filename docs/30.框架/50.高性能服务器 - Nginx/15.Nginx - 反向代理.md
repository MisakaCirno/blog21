...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127232009.png)
...
![1589729000713](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127233228.png)
...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127233357.png)

（5）设置完成后，再次通过浏览器访问服务端

![1589729479920](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127233557.png)
...
![image-20211127235211231](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127235212.png)
...
![image-20211128004707577](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211128004709.png)
...
![image-20211128005045545](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211128005051.png)
...
- 代理服务器 A 收到服务器 B 的欢迎页面和地址，但是我们不能直接返回给客户端，因为它会暴露服务器 B 的地址，这是重定向的原因
    ...
    ![image-20211128010908502](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211128010909.png)
...
![1581883378672](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211128013511.png)
...
![1589908851340](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211128112859.png)
...
![image-20211201225251558](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211201225252.png)

![image-20211201225105734](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211201225145.png)

![image-20211201225336457](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211201225337.png)

购买成功后，去创建证书

![image-20211201225535459](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211201225536.png)

接着在右边弹窗进行域名绑定，填完写域名和个人信息，进入到验证信息

![image-20211201230854077](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211201230854.png)

点击验证，不成功则去自己的域名解析列表查看，如下，点击添加记录，进行配置，或者已经看到记录类型是 TXT，记录值和上图一样的，则说明成功。

![image-20211201230649050](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211201230649.png)

提交审核后，点击下载

![image-20211201225752829](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211201225753.png)

下载 Nginx 服务器的证书

![image-20211201225810829](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211201225812.png)
...
![image-20211128123148938](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211128123150.png)
...
![image-20211128123503786](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211128123504.png)
...
![1581879638569](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211128132156.png)
