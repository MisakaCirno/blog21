...
![image-20211202223805054](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211202223818.png)

此时访问 `112.74.169.231` 是成功的，虽然该 IP 不是 `llll`，但是也因为匹配上其他的 `server_name`，所以「无奈选择」第一个 server 块，也就是这个 `llll` 的 `server_name`。



![image-20211202223906347](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211202224135.png)

但是我们把这个 server 块变成第二个 server 块时，而第一个 server 块返回 403：

![image-20211202224311372](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211202224902.png)

再次访问，直接返回 403，别在意上面的 `default_server`，我刚才去掉测试了，同样也返回 403。

![image-20211202224352288](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211202224356.png)
...
![1587655397104](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127155803.png)



![1587665814562](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127155826.png)
...
![1587832596733](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127160205.png)
...
- `gzip_vary` 指令是用于设置使用 Gzip 进行压缩发送是否携带『Vary:Accept-Encoding』头域的响应头部。主要是告诉接收方，所发送的数据经过了 Gzip 压缩处理。默认关闭
	...
	![1587361606028](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127162313.png)
...
![image-20211127184134454](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127184135.png)

(1) 直接访问 `http://192.168.199.27/jquery.js`

![1587932106429](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127165536.png)
...
![1587932300006](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127165540.png)
...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127170105.png)
...
![image-20211127172853516](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211127172854.png)
