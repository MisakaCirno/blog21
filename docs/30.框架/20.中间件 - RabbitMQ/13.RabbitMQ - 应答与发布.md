...
![image-20211109191455909](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/RabbitMQ/20211109191456.png)

### 消息自动重新入队

如果消费者由于某些原因失去连接(其通道已关闭，连接已关闭或 TCP 连接丢失)，导致消息未发送 ACK 确认，RabbitMQ 将了解到消息未完全处理，并将对其重新排队。如果此时其他消费者可以处理，它将很快将其重新分发给另一个消费者。这样，即使某个消费者偶尔死亡，也可以确保不会丢失任何消息。

![image-20211109191528743](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/RabbitMQ/20211109191530.png)
...
![image-20211109193046505](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/RabbitMQ/20211109193047.png)
...
![image-20211109193341523](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/RabbitMQ/20211109193342.png)

![image-20211109193534701](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/RabbitMQ/20211109193536.png)
...
![image-20211109213659474](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/RabbitMQ/20211109213700.png)

以下为控制台中持久化与非持久化队列的 UI 显示区

![image-20211109213727483](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/RabbitMQ/20211109213729.png)
...
![image-20211109214706617](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/RabbitMQ/20211109214708.png)
...
![image-20211109221107761](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/RabbitMQ/20211109221108.png)
...
![image-20211109215549448](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/RabbitMQ/20211109215748.png)
...
![image-20211109224549666](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/RabbitMQ/20211109224550.png)
