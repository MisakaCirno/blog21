...
![image-20210409105838259](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226154905.png)

下图展示了频道 channel1 ， 以及订阅这个频道的三个客户端 —— client2 、 client5 和 client1 之间的关系：

![image-20210409105859670](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226154929.png)

当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：

![image-20210409110314032](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226154637.png)
