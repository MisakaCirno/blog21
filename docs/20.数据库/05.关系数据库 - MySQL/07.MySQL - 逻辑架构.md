...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024145813.png)
...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024145830.png)

真正执行的顺序：

​		随着 Mysql 版本的更新换代，其优化器也在不断的升级，优化器会分析不同执行顺序产生的性能消耗不同而动 态调整执行顺序。下面是经常出现的查询顺序：

![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024145851.png)

![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024145901.png)
...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024145911.png)
...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024145928.png)
...
- 事务控制
  ...
  **
  ...
  ![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024145939.png)
...
- 外键约束
  ...
  ![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024145949.png)
  ...
  ![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150009.png)

  删除 country_id为 1 的 country 数据，有外键时会删除失败

  ![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150021.png)
  ...
  ![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150028.png)

  更新后， 子表的数据信息为 ：

  ![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150035.png)
...
- **存储方式**	
  ...
  ![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150046.png)
...
- 不支持事务
  ...
  ![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150058.png)
...
- 文件存储方式
  ...
  ![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150117.png)
...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150127.png)
...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150150.png)

order_1991中的数据 ： 

![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150200.png)

order_all中的数据 ：

![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150208.png)
...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150216.png)
...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211024150226.png)
