...
![image-20220204204433919](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220204204434.png)
...
![image-20220204202944713](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220204202946.png)
...
![image-20220204204823018](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220204204824.png)

如上图的多个文件夹是早期开发的不同工具对应的文件夹，导致无法统一资源目录，而 Maven 的出现统一了资源目录，让什么资源放在什么目录的结构称为标准。

Maven Java 资源目录如下：

![image-20220204205049233](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220204205050.png)
...
![image-20220205154044174](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205154052.png)
...
![image-20220205154233546](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205154234.png)

我这里叫 M2_HOME，也可以叫 MAVEN_HOME。

配置好 Maven 的环境变量后，需要找到 Path，配置 Maven 的 bin 目录。

![image-20220205154449025](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205154449.png)

### 测试

确保我们配置的内容已经生效，在命令行输入 `mvn`，如果看到如图效果代表成功，只要不出现 `mvn` 不是内部或外部命令都代表成功。

![image-20220205154727625](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205154728.png)

## Maven基础概念

### 仓库

![image-20220205154839352](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205154840.png)
...
![image-20220205160117630](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205160118.png)
...
![image-20220205160232320](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205160233.png)
...
![image-20220205161234139](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205161235.png)
...
![image-20220205161435355](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205161436.png)
...
![image-20220205162703391](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205162704.png)
...
![image-20220205163025681](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205163028.png)

然后新建工程的时候，选择 Maven 即可。

![image-20220205163136155](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205163137.png)

创建 Java 项目，选择 archetype-quickstart 进行项目创建

![image-20220205163351035](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205163351.png)

创建 Web 项目，选择 archetype-webapp 进行项目创建

![image-20220205163301369](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205163302.png)
...
![image-20220205163733211](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205163734.png)
...
![image-20220205163752193](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205163752.png)
...
![image-20220205165618964](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205165619.png)
...
![image-20220205170528926](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/maven/20220205170529.png)
