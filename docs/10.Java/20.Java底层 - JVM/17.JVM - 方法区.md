...
![image-20200708093918121](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153701.png)

从线程共享与否的角度来看

![image-20200708094507624](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153703.png)
...
![image-20200708094747667](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153704.png)
...
![image-20200708095853544](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153705.png)
...
![image-20220120203714964](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220120203717.png)
...
![image-20200708103055914](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153709.png)
...
![image-20200708102919149](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153707.png)
...
![image-20200708111756800](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153711.png)
...
![image-20200708161728320](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153712.png)

《深入理解 Java 虚拟机》书中对方法区（Method Area）存储内容描述如下：它用于存储已被虚拟机加载的 **类型信息、常量、静态变量、即时编译器编译后的代码缓存等**。

![image-20200708161856504](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153714.png)
...
![image-20200708171151384](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153717.png)
...
![image-20200708172357052](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153718.png)
...
![image-20200708204750374](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153721.png)

首先现将操作数 500 放入到操作数栈中

![image-20200708204953552](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153722.png)

然后存储到局部变量表中

![image-20200708205029376](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153724.png)

然后重复一次，把 100 放入局部变量表中，最后再将变量表中的 500 和 100 取出，进行操作

![image-20200708205221737](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153740.png)

将 500 和 100 进行一个除法运算，再把结果入栈

![image-20200708205413721](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153742.png)

在最后就是输出流，需要调用运行时常量池的常量

![image-20200708205708057](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153725.png)

最后调用 invokevirtual（虚方法调用），然后返回

![image-20200708205909176](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153727.png)

返回时

![image-20200708210540696](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153728.png)
...
![image-20200708211541300](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153751.png)

JDK7 的时候

![image-20200708211609911](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153752.png)

JDK8 的时候，元空间大小只受物理内存影响

![image-20200708211637952](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153754.png)
...
![image-20220122000448931](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220122000450.png)

JDK7 环境下

![image-20220122000618508](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220122000619.png)

JDK8 环境

![image-20220122000647916](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220122000648.png)
...
![image-20200708215025527](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153758.png)
...
![image-20200708215218078](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153759.png)
...
![image-20200708220303243](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220116153801.png)
