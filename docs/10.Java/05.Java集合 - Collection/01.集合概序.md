...
![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java集合/20211024143713.png)
...
- ArrayList实现了长度可变的数组，在内存中分配连续的空间。遍历元素和随机访问元素的效率比较高
  ...
  ![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java集合/20211024144026.png)
  

- LinkedList采用链表存储方式。插入、删除元素时效率比较高

  ![](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java集合/20211024144045.png)
