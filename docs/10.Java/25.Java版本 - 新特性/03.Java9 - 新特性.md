...
![image-20220210151110397](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210151118.png)
...
![image-20220210151235086](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210151235.png)
...
![image-20220210151408535](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210151409.png)
...
![image-20220210155128270](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210155129.png)
...
![image-20220210161720608](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210161721.png)

> 获取帮助

任何命令行工具都有 `help` 帮助提示，JShell 也不例外，输入 `/help intro` 即可看到帮助。

![image-20220210161814112](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210161815.png)
...
![image-20220210161919681](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210161920.png)

![image-20220210161931145](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210161932.png)
...
![image-20220210162155889](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210162156.png)

> 默认已经导入如下的所有包：（包含 `java.lang` 包）

通过 `/import` 指令可以查看默认导入的包：

![image-20220210162234969](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210162236.png)

> 只需按下 Tab 键，就能自动补全代码

![image-20220210162249456](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210162250.png)

> 列出当前 session 里所有有效的代码片段

通过 `/list` 指令列出曾经输入的代码片段。

![image-20220210162410111](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210162410.png)

> 查看当前 session 下所有创建过的变量

通过 `/var` 指令列出所有创建过的变量。

![image-20220210162420212](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210162421.png)

> 查看当前 session 下所有创建过的方法

通过 `/methods` 指令列出所有创建过的方法。

![image-20220210162441281](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210162442.png)
...
![image-20220210162517736](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210162518.png)
...
![image-20220210181532432](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210181533.png)
...
![image-20220210201349926](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210201350.png)

下图是在 Java 9 中，添加了一个搜索框。

![image-20220210201401665](https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210201402.png)
