...
module.exports = [
  ...
  // ['script', { src: 'https://gcore.jsdelivr.net/npm/react/umd/react.production.min.js' }],
  // ['script', { src: 'https://gcore.jsdelivr.net/npm/react-dom/umd/react-dom.production.min.js' }],
  // ['script', { src: 'https://gcore.jsdelivr.net/npm/vue/dist/vue.min.js' }],
  // ['script', { src: 'https://gcore.jsdelivr.net/npm/@babel/standalone/babel.min.js' }],
  // Twikoo 评论系统
