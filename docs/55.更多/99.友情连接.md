...
- name: Weibw
  ...
  avatar: https://gcore.jsdelivr.net/gh/Weibw162/image-hosting@dev/%E6%9D%82%E5%BD%95/image.735febsv1zo0.webp
  desc: 一个没有梦想的咸鱼
  bgColor: '#FFCEDE'
  textColor: '#621529'
...
- name: xustudyxu
  desc: 一起学习编程!
  avatar: https://gcore.jsdelivr.net/gh/xustudyxu/image-hosting@master/20220423/01.3d9wrma6qlq0.webp
...
```yml
- name: Shiki24のBlog	# 昵称
  desc: 故事由我书写，旅程由你见证，传奇由她聆听	# 介绍
  avatar: https://gcore.jsdelivr.net/gh/Kele-Bingtang/static/user/avatar2.png	# 头像
